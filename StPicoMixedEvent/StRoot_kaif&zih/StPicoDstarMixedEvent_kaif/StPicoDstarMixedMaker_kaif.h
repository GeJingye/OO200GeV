...
class StPicoDstarMixedMaker : public StMaker
{
  ...
  private: 
   ...
   //tracl level QA
	...
	//给 ROOT 的 I/O、反射、RTTI、脚本绑定提供运行时类信息；凡要写入/读取 .root 文件或在交互命令行中用到的类，都必须加ClassDef()。
	//必须是public区？
