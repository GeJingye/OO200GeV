...
void DrawNSigmaEPiKP(TString inFilename = "roots/25_20260119_iTPC_rmLowP_newPhiVcut.root", Int_t number = 25) //
{
	// 从root文件中导入待拟合的直方图
	...
	TH2F *h_nSigmaPion_P = (TH2F *)inFile->Get("h_nSigmaPion_P");if(!h_nSigmaPion_P) {cout<<"h_nSigmaPion_P not found! Exiting..."<<endl; return;}
	TH2F *h_nSigmaPicorr_P = (TH2F *)inFile->Get("h_nSigmaPicorr_P");if(!h_nSigmaPicorr_P) {cout<<"h_nSigmaPicorr_P not found! Exiting..."<<endl; return;}
	// total
	TH2F *h_nSigmaElectron_P__EIDcut_total = (TH2F *)inFile->Get("h_nSigmaElectron_P__EIDcut_total");if(!h_nSigmaElectron_P__EIDcut_total) {cout<<"h_nSigmaElectron_P__EIDcut_total not found! Exiting..."<<endl; return;}
	// group 1
	...
	// group 2
	TH2F *h_nSigmaElectron_P__2 = (TH2F *)inFile->Get("h_nSigmaElectron_P__2");if(!h_nSigmaElectron_P__2) {cout<<"h_nSigmaElectron_P__2 not found! Exiting..."<<endl; return;}
	TH2F *h_nSigmaKaon_P__2 = (TH2F *)inFile->Get("h_nSigmaKaon_P__2");if(!h_nSigmaKaon_P__2) {cout<<"h_nSigmaKaon_P__2 not found! Exiting..."<<endl; return;}
	TH2F *h_nSigmaProton_P__2 = (TH2F *)inFile->Get("h_nSigmaProton_P__2");if(!h_nSigmaProton_P__2) {cout<<"h_nSigmaProton_P__2 not found! Exiting..."<<endl; return;}
	TH2F *h_nSigmaElectron_P__PID_2 = (TH2F *)inFile->Get("h_nSigmaElectron_P__PID_2");if(!h_nSigmaElectron_P__PID_2) {cout<<"h_nSigmaElectron_P__PID_2 not found! Exiting..."<<endl; return;}
	TH2F *h_nSigmaElectron_P__EIDcut_2 = (TH2F *)inFile->Get("h_nSigmaElectron_P__EIDcut_2");if(!h_nSigmaElectron_P__EIDcut_2) {cout<<"h_nSigmaElectron_P__EIDcut_2 not found! Exiting..."<<endl; return;}
	TH2F *h_nSigmaElectron_Eta__EIDcut_2 = (TH2F *)inFile->Get("h_nSigmaElectron_Eta__EIDcut_2");if(!h_nSigmaElectron_Eta__EIDcut_2) {cout<<"h_nSigmaElectron_Eta__EIDcut_2 not found! Exiting..."<<endl; return;}
	// group 3
	TH2F *h_nSigmaElectron_P__3 = (TH2F *)inFile->Get("h_nSigmaElectron_P__3");if(!h_nSigmaElectron_P__3) {cout<<"h_nSigmaElectron_P__3 not found! Exiting..."<<endl; return;}
	TH2F *h_nSigmaPion_P__3 = (TH2F *)inFile->Get("h_nSigmaPion_P__3");if(!h_nSigmaPion_P__3) {cout<<"h_nSigmaPion_P__3 not found! Exiting..."<<endl; return;}
	TH2F *h_nSigmaKaon_P__3 = (TH2F *)inFile->Get("h_nSigmaKaon_P__3");if(!h_nSigmaKaon_P__3) {cout<<"h_nSigmaKaon_P__3 not found! Exiting..."<<endl; return;}
	TH2F *h_nSigmaElectron_P__PID_3 = (TH2F *)inFile->Get("h_nSigmaElectron_P__PID_3");if(!h_nSigmaElectron_P__PID_3) {cout<<"h_nSigmaElectron_P__PID_3 not found! Exiting..."<<endl; return;}
	TH2F *h_nSigmaElectron_P__EIDcut_3 = (TH2F *)inFile->Get("h_nSigmaElectron_P__EIDcut_3");if(!h_nSigmaElectron_P__EIDcut_3) {cout<<"h_nSigmaElectron_P__EIDcut_3 not found! Exiting..."<<endl; return;}
	TH2F *h_nSigmaElectron_Eta__EIDcut_3_lowP = (TH2F *)inFile->Get("h_nSigmaElectron_Eta__EIDcut_3_lowP");if(!h_nSigmaElectron_Eta__EIDcut_3_lowP) {cout<<"h_nSigmaElectron_Eta__EIDcut_3_lowP not found! Exiting..."<<endl; return;}
	TH2F *h_nSigmaElectron_Eta__EIDcut_3_highP = (TH2F *)inFile->Get("h_nSigmaElectron_Eta__EIDcut_3_highP");if(!h_nSigmaElectron_Eta__EIDcut_3_highP) {cout<<"h_nSigmaElectron_Eta__EIDcut_3_highP not found! Exiting..."<<endl; return;}
	//TH2F *h_nSigmaElectron_P__EIDcutcut_total = (TH2F *)inFile->Get("h_nSigmaElectron_P__EIDcutcut_total");if(!h_nSigmaElectron_P__EIDcutcut_total) {cout<<"h_nSigmaElectron_P__EIDcutcut_total not found! Exiting..."<<endl; return;}
	...
	// printHist2DSci(h_e_p__Number_Same);
	...
	// printHist2DSci(h_e_p__Number_Mix);
	...
	// 	if (Tag == "P24iy")
	// 	{
	// 		TLine *line2_K1 = new TLine(0.0, -2.5, 5.0, -2.5);
	// 		line2_K1->SetLineColor(kRed);
	// 		line2_K1->Draw("same");
	// 		TLine *line2_K2 = new TLine(0.0, 4.0, 5.0, 4.0);
	...
	// 	if (Tag == "P24iy")
	// 	{
	// 		TLine *line2_P1 = new TLine(0.0, -2.2, 5.0, -2.2);
	// 		line2_P1->SetLineColor(kRed);
	// 		line2_P1->Draw("same");
	// 		TLine *line2_P2 = new TLine(0.0, 4.2, 5.0, 4.2);
	// 		line2_P2->SetLineColor(kRed);
	// 		line2_P2->Draw("same");
	// 	}
	// 	else
	// 	{
	// 		TLine *line2_P1 = new TLine(0.0, 6.0, 1.5, 4.0);
	// 		line2_P1->SetLineColor(kRed);
	// 		line2_P1->Draw("same");
	// 		TLine *line2_P2 = new TLine(1.5, 4.0, 5.0, 4.0);
	// 		line2_P2->SetLineColor(kRed);
	// 		line2_P2->Draw("same");
	// 		TLine *line2_P3 = new TLine(0.0, 0.0, 1.5, -2.0);
	// 		line2_P3->SetLineColor(kRed);
	// 		line2_P3->Draw("same");
	// 		TLine *line2_P4 = new TLine(1.5, -2.0, 5.0, -2.0);
	// 		line2_P4->SetLineColor(kRed);
	// 		line2_P4->Draw("same");
	// 	}
	...
	// 	if (Tag == "P24iy")
	// 	{
	// 		TLine *line2_E1 = new TLine(0.0, -1.5, 5.0, -1.5);
	// 		line2_E1->SetLineColor(kRed);
	// 		line2_E1->Draw("same");
	// 		TLine *line2_E2 = new TLine(0.0, 2.0, 5.0, 2.0);
	...
	// 		line3_Pi2->SetLineColor(kRed);
	// 		line3_Pi2->Draw("same");
	// 		TLine *line3_Pi3 = new TLine(0.2, -5.0, 0.7, -5.0);
	// 		line3_Pi3->SetLineColor(kRed);
	// 		line3_Pi3->Draw("same");
	// 	}
	// 	else
	// 	{
	// 		TLine *line3_Pi1 = new TLine(0.0, 5.0, 0.7, 5.0);
	// 		line3_Pi1->SetLineColor(kRed);
	// 		line3_Pi1->Draw("same");
	// 		TLine *line3_Pi2 = new TLine(0.0, -1.0, 0.2, -5.0);
	// 		line3_Pi2->SetLineColor(kRed);
	...
	// 	if (Tag == "P24iy")
	// 	{
	// 		TLine *line3_K1 = new TLine(0.0, 5.0, 0.7, 5.0);
	// 		line3_K1->SetLineColor(kRed);
	// 		line3_K1->Draw("same");
	// 		TLine *line3_K2 = new TLine(0.0, -6.0, 0.7, 3.5);
	// 		line3_K2->SetLineColor(kRed);
	// 		line3_K2->Draw("same");
	// 	}
	// 	else
	// 	{
	// 		TLine *line3_K1 = new TLine(0.0, 8.0, 0.7, 8.0);
	// 		line3_K1->SetLineColor(kRed);
	// 		line3_K1->Draw("same");
	// 		TLine *line3_K2 = new TLine(0.0, -6.0, 0.7, 3.5);
	// 		line3_K2->SetLineColor(kRed);
	...
	// 	if (Tag == "P24iy")
	// 	{
	// 		TLine *line3_E1 = new TLine(0.0, 1.0, 0.18, 1.0);
	// 		line3_E1->SetLineColor(kRed);
	// 		line3_E1->Draw("same");
	// 		TLine *line3_E2 = new TLine(0.18, 1.0, 0.18, 3.0);
	// 		line3_E2->SetLineColor(kRed);
	// 		line3_E2->Draw("same");
	// 		TLine *line3_E3 = new TLine(0.18, 3.0, 0.7, 3.0);
	// 		line3_E3->SetLineColor(kRed);
	// 		line3_E3->Draw("same");
	// 		TLine *line3_E4 = new TLine(0.0, -4.0, 0.14, -4.0);
	// 		line3_E4->SetLineColor(kRed);
	// 		line3_E4->Draw("same");
	// 		TLine *line3_E5 = new TLine(0.14, -4.0, 0.14, -2.0);
	// 		line3_E5->SetLineColor(kRed);
	// 		line3_E5->Draw("same");
	// 		TLine *line3_E6 = new TLine(0.14, -2.0, 0.7, -2.0);
	// 		line3_E6->SetLineColor(kRed);
	// 		line3_E6->Draw("same");
	// 	}
	// 	else
	// 	{
	...
	// 		line3_E1->SetLineColor(kRed);
	// 		line3_E1->Draw("same");
	// 		TLine *line3_E2 = new TLine(0.18, 1.0, 0.18, 4.0);
	// 		line3_E2->SetLineColor(kRed);
	// 		line3_E2->Draw("same");
	// 		TLine *line3_E3 = new TLine(0.18, 4.0, 0.7, 4.0);
	// 		line3_E3->SetLineColor(kRed);
	// 		line3_E3->Draw("same");
	// 		TLine *line3_E4 = new TLine(0.0, -4.0, 0.14, -4.0);
	// 		line3_E4->SetLineColor(kRed);
	// 		line3_E4->Draw("same");
	// 		TLine *line3_E5 = new TLine(0.14, -4.0, 0.14, -1.0);
	// 		line3_E5->SetLineColor(kRed);
	// 		line3_E5->Draw("same");
	// 		TLine *line3_E6 = new TLine(0.14, -1.0, 0.7, -1.0);
	// 		line3_E6->SetLineColor(kRed);
	// 		line3_E6->Draw("same");
	// 	}
	...
	if (1) // check PhiV cut
	{
		...
		gPad->SetRightMargin(0.12);
		gStyle->SetOptStat(0);
		h_Mee__unlikeSame->GetXaxis()->SetRangeUser(0, 1.0);
		...
		gPad->SetRightMargin(0.12);
		gStyle->SetOptStat(0);
		h_Mee__unlikeSame->GetXaxis()->SetRangeUser(0, 4.0);
		h_Mee__unlikeSame->DrawClone("");
		h_Mee__unlikeSame__w_PhiV_Cut->DrawClone("same");
